...
class CustomerUpdateTest extends TestCase
{
    ...
    public function testIfTheCustomerUpdateRulesAreTheSameAsExpected()
    {
        $request = new CustomerUpdate();
        $request->customer = Customer::factory()->create();
            ...
            [
                ...
                'cpf_cnpj' => [
                    ...
                    Rule::unique('customers')
                        ...
                        ->whereNot('uuid', $request->customer->uuid),
                ],
